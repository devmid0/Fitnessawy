...
function renderCards() {
  ...
  currentWorkout.exercises.forEach(function (ex, ei) {
    ...
    html += '<button class="log-delete-ex-btn" data-ex="' + ei + '" title="Remove Exercise">';
...
function onClick(e) {
  var deleteExBtn = e.target.closest('.log-delete-ex-btn');
  if (deleteExBtn) { deleteExercise(+deleteExBtn.dataset.ex); return; }
